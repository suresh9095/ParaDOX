              ...
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form className="mx-1 mx-md-4">
                  ...
                  <div className=" justify-content-center mx-4 mb-3 mb-lg-4">
                    ...
                    <div className=" my-4">
                       <p className="" style={{fontWeight:"bold",marginLeft:"30px"}}>OR</p>
                  </div>
                    <button style={{border:"none"}}><Link className="text-decoration-none btn btn-primary btn-lg"  to="/login" >Login</Link> </button>
                  </div>
                </form>
              </div>
